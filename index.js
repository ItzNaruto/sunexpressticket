            ...
            interaction.guild.channels.create({
                ...
                interaction.reply({
                    embeds: [
                        ...
                        .setDescription(`Successfully created __support__ request ${cha}`)
                    ],
                    ephemeral: true
                })
                ...
                .setDescription(`Successfully __support__ your request has been opened wait for the authorities!`)
                .setThumbnail(interaction.guild.iconURL())
                const button = new ActionRowBuilder()
                .addComponents(
                    new ButtonBuilder()
                    .setLabel("End Support")
    ...
    if(interaction.customId === "ticket_sonlandir") {
        ...
        data.send({
            embeds: [
                ...
                .setDescription(`The support request has been closed by the user who has closed <@${interaction.user.id}> (${interaction.user.username})`)
            ]
        })
